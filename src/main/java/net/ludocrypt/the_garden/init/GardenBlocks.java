...
public class GardenBlocks {
	...
	public static final Block OSB_STAIRS = add("osb_stairs", new TerraformStairsBlock(OSB_BOARD, FabricBlockSettings.copyOf(OSB_BOARD)), ItemGroup.BUILDING_BLOCKS);
	public static final Block OSB_SLAB = add("osb_slab", new SlabBlock(FabricBlockSettings.copyOf(OSB_BOARD)), ItemGroup.BUILDING_BLOCKS);
	public static final Block OSB_WALL = add("osb_wall", new WallBlock(FabricBlockSettings.copyOf(OSB_BOARD)), ItemGroup.DECORATIONS);
	public static final Block CORK = add("cork", new Block(FabricBlockSettings.copyOf(Blocks.WARPED_HYPHAE).breakByTool(FabricToolTags.AXES).materialColor(DyeColor.YELLOW)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block CORK_BRICKS = add("cork_bricks", new Block(FabricBlockSettings.copyOf(Blocks.WARPED_PLANKS).breakByTool(FabricToolTags.AXES).materialColor(DyeColor.YELLOW)), ItemGroup.BUILDING_BLOCKS);
