...
public class DeadTreeSpineFeature extends Feature<DefaultFeatureConfig> {

	public DeadTreeSpineFeature(Codec<DefaultFeatureConfig> configCodec) {
		super(configCodec);
	}
	...
	public boolean generate(StructureWorldAccess world, ChunkGenerator chunkGenerator, Random random, BlockPos pos, DefaultFeatureConfig config) {
		...
		double height = random.nextDouble() * 15 + 20;
