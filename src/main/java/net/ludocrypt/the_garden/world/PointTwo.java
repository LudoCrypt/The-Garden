...
public class PointTwo {
	...
	public static final Identifier IDENTIFIER = TheGarden.id("point_two");
	...
	public static final DimensionType DIMENSION_TYPE = DimensionTypeAccessor.createDimensionType(OptionalLong.of(300), true, false, false, false, 7.0D, false, false, false, true, false, 256, VoronoiBiomeAccessType.INSTANCE, BlockTags.INFINIBURN_OVERWORLD.getId(), SKY, 0.3F);
	...
	private static ChunkGeneratorSettings createSettings() {
		return ChunkGeneratorSettingsAccessor.createChunkGeneratorSettings(new StructuresConfig(false), new GenerationShapeConfig(256, new NoiseSamplingConfig(1.03987899D, 1.65896786D, 48.14848948D, 200.34898838D), new SlideConfig(0, 0, 0), new SlideConfig(0, 0, 0), 1, 2, -2.318897D, 1.695827D, true, true, false, false), GardenBlocks.PLAYDIRT.getDefaultState(), GardenBlocks.PLAYDIRT.getDefaultState(), 0, -10, -1, false);
	}
	...
	public static ChunkGenerator createGenerator(Registry<Biome> biomeRegistry, Registry<ChunkGeneratorSettings> chunkGeneratorSettingsRegistry, long seed) {
		return new NoiseChunkGenerator(BIOME_SOURCE_PRESET.getBiomeSource(biomeRegistry, seed), seed, () -> {
			return (ChunkGeneratorSettings) chunkGeneratorSettingsRegistry.getOrThrow(CHUNK_GENERATOR_SETTINGS);
		});
	}
